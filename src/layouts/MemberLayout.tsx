            ...
            <aside className="w-64 bg-white border-r border-slate-200 hidden md:flex flex-col">
                ...
                <div className="p-4 border-t border-slate-200 bg-slate-50/50">
                    ...
                    {isStaff && (
                        <NavLink
                            to="/staff/dashboard"
                            className="flex items-center justify-center w-full px-4 py-2 mb-2 text-sm text-amber-700 bg-amber-50 rounded-lg hover:bg-amber-100 transition-colors border border-amber-200 font-medium"
                        >
