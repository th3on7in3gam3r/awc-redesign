...
const StoreOrderConfirmation: React.FC = () => {
  ...
  if (!id) {
    return (
      <div className="bg-gray-50 min-h-screen pt-28 pb-14 text-center px-6">
        ...
        {!loading && needsEmail && (
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 space-y-4">
            ...
            <button
              ...
              className="bg-church-burgundy text-white px-5 py-2.5 rounded-lg text-[10px] font-bold uppercase tracking-widest"
            >
              View Order
            </button>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div className="text-center flex flex-col sm:flex-row gap-2 justify-center">
              <button
                ...
                className="inline-block border border-gray-200 text-slate-600 px-5 py-2.5 rounded-lg text-[10px] font-bold uppercase tracking-widest hover:border-church-burgundy"
              >
                Refresh Status
              </button>
              <Link
                to="/store"
                className="inline-block bg-church-burgundy text-white px-5 py-2.5 rounded-lg text-[10px] font-bold uppercase tracking-widest hover:bg-church-gold transition-all"
              >
                Continue Shopping
              </Link>
            </div>
